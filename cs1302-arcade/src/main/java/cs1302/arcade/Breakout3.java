 ...
 * @version 1.0
 */
public class Breakout3 extends Application{
    ...
    BreakoutBrick3 brick;
    BreakoutBall3 ball;
    BreakoutPaddle3 paddle;
	...
	brick = new BreakoutBrick3();
	ball = new BreakoutBall3();
	paddle = new BreakoutPaddle3();
	
	/* sets nodes */
	nodes = new ArrayList<>();
	nodes.add(brick.getBrick(4,5));
	nodes.add(brick.getBrick(4,6));
