 ...
 * @version 1.0
 */
public class Breakout2 extends Application{
    ...
    BreakoutBrick2 brick;
    BreakoutBall2 ball;
    BreakoutPaddle2 paddle;
	...
	brick = new BreakoutBrick2();
	ball = new BreakoutBall2();
	paddle = new BreakoutPaddle2();
	
	/* sets nodes */
	nodes = new ArrayList<>();
	nodes.add(brick.getBrick(3,5));
	nodes.add(brick.getBrick(3,6));
